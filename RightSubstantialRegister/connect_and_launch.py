...
async def start_server():
    ...
    element = driver.find_element('xpath',"//*[@id=\"start\"]")
    element.click()
    ...
    while get_status() == "Waiting in queue":
        ...
        await asyncio.sleep(3)
        try:
            element = driver.find_element('xpath','//*[@id="confirm"]')
            element.click()
...
def get_status():
    ...
    return driver.find_element('xpath','//*[@id="nope"]/main/section/div['
...
def get_number_of_players():
    ...
    try:
        return driver.find_element('xpath','//*[@id="nope"]/main/section'
...
def get_software():
    """ Returns the server software.
        Works: Always works"""
    return driver.find_element('xpath','//*[@id="software"]').text


def get_version():
    """ Returns the server version.
        Works: Always works"""
    return driver.find_element('xpath','//*[@id="version"]').text
...
def connect_account():
    ...
    driver.get(URL)
    # login to aternos
    element = driver.find_element('xpath','//*[@id="user"]')
    element.send_keys('aglw00')
    element = driver.find_element('xpath','//*[@id="password"]')
    element.send_keys('bobross')
    element = driver.find_element('xpath','//*[@id="login"]')
    element.click()
    time.sleep(2)

    # selects server from server list
    element = driver.find_element('css','body > div > main > section'
...
def adblockBypass():
    time.sleep(1)
    element = driver.find_element('xpath','//*[@id="sXMbkZHTzeemhBrPtXgBD'
...
async def stop_server():
    ...
    element = driver.find_element('xpath',"//*[@id=\"stop\"]")
    element.click()
