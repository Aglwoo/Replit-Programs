...
def enemy(xe,ye):
  ...
  pygame.draw.rect(win,(0,0,100),((xe - 5,ye - 3,4,4)))
  pygame.draw.rect(win,(0,0,100),((xe + 3,ye - 3,4,4)))
  pygame.draw.rect(win,(0,0,100),((xe - 4,ye + 4,10,3)))
  pygame.draw.rect(win,(0,0,100),((xe - 5,ye + 4,2,5)))
  pygame.draw.rect(win,(0,0,100),((xe + 4,ye + 4,2,5)))
  pygame.draw.rect(win,(0,0,100),((xe - 7,ye + 6,2,5)))
  pygame.draw.rect(win,(0,0,100),((xe + 6,ye + 6,2,5)))
